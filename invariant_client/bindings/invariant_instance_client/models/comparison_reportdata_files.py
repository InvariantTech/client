...
T = TypeVar("T", bound="ComparisonReportdataFiles")


@_attrs_define
class ComparisonReportdataFiles:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        comparison_reportdata_files = cls()
        ...
        comparison_reportdata_files.additional_properties = additional_properties
        return comparison_reportdata_files
