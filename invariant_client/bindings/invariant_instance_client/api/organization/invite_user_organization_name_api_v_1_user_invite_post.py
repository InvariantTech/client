...
def _get_kwargs(
    ...
    *,
    json_body: InviteUserRequest,
) -> Dict[str, Any]:
    json_json_body = json_body.to_dict()

    return {
        "method": "post",
        "url": "/{organization_name}/api/v1/user/invite".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Invite a user to join this organization
     ...
     Invite a user to join this organization. A new login will be created if one does not already exist.
